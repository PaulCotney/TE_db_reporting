...
perl -p -e 's/\|/-/g' raw_csv/denovoTE105_start.csv > raw_csv/denovoTE105_start.clean.csv
perl -p -e 's/\|/-/g' raw_csv/denovoTE105_end.csv > raw_csv/denovoTE105_end.clean.csv
